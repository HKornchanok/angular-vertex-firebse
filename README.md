...
1. Take your project settings from Firebase Console and add them to `src/environments/environment.ts`. You can find these settings in your Firebase Console under Project Settings > General > Your Apps > Web App. Copy the configuration object and replace the example values:
